...
17 COMPARES_CONSTANTS_WITH_THE_VALUES_THAT_WERE_ASSIGNED_TO_THEM
Description
``Voting`` 134 - 140 lines    
 unnecessary superfluous asserts. we're wasting gas
Recommendation
delete lines 134 - 140
18  MISSING_PARAM_COMMENT_FOR__MINBALANCEUPPERLIMIT
Description
...
19 TYPO_IN_THE_WORD_AVAILIABLE
Description
``La ``88 line
```
function availiableSupply() external view returns(uint256) {
